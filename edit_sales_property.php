            ...
            <div class="table-responsive">
                <table class="table table-bordered">
                    ...
                    <tr>
                        <td colspan="3">
                            Address Line 1: <br>
                            <input style="margin-top: 12px; margin-bottom: 6px" type="text" name="Address1"
                                class="form-control" value="<?php echo $row['Address1']; ?>">
                            Address Line 2: <br>
                            <input style="margin-top: 3px; margin-bottom: 6px" type="text" name="Address2"
                                class="form-control" value="<?php echo $row['Address2']; ?>">
                            Address Line 3: <br>
                            <input style="margin-top: 3px; margin-bottom: 6px" type="text" name="Address3"
                                class="form-control" value="<?php echo $row['Address3']; ?>">
                            Postcode: <br>
                            <input style="margin-top: 3px; margin-bottom: 6px" type="text" name="postcode"
                                class="form-control" value="<?php echo $row['postcode']; ?>">
                        </td>
                        <td>
                            <h4>Status: </h4><br>
                            <input name="sales_availability" type="text"
                                value="<?php echo $row['sales_availability']; ?>">
                    ...
                    <tr>
                        <td>Level & Dwelling Type: <br>
                            <input type="text" name="property_level" class="form-control"
                                value="<?php echo $row['property_level']; ?>" />
                        </td>
                        <td>Dwelling Type: <br>
                            <input type="text" name="dwelling_type" class="form-control"
                                value="<?php echo $row['dwelling_type']; ?>" />
                        </td>
                        <td>Price:<br>
                        ...
                        <td>
                            Sales Tenure:
                            <input type="text" name="sales_tenure" class="form-control"
                                value="<?php echo $row['sales_tenure']; ?>" />
                        </td>
                    </tr>
                    <tr>
                        <td>Bedrooms:<br>
                            <input type="text" name="bedrooms" class="form-control"
                                value="<?php echo $row['bedrooms']; ?>" />
                        </td>
                        <td>Bathrooms:<br>
                            <input type="text" name="bathrooms" class="form-control"
                                value="<?php echo $row['bathrooms']; ?>" />
                        </td>
                        <td>Reception Rooms: <br>
                            <input type="text" name="receptions" class="form-control"
                                value="<?php echo $row['receptions']; ?>" />
                        </td>
                        <td>Local Borough: <br>
                            <input type="text" name="borough" class="form-control"
                                value="<?php echo $row['borough']; ?>">
                        </td>
                    </tr>
                    <tr>
                        <td>Outside Space: <br>
                            <input type="text" name="garden" class="form-control"
                                value="<?php echo $row['garden']; ?>" />
                        </td>
                        <td>Parking: <br>
                            <input type="text" name="parking" class="form-control"
                                value="<?php echo $row['parking']; ?>" />
                        </td>
                        <td>
                            <a target="_blank"
                                href="https://www.epcregister.com/reportSearchAddressTerms.html?redirect=reportSearchAddressByPostcode">
                                Floor Area:
                            </a>
                            <br> 
                            <input type="text" name="floor_area" placeholder="sq.m." class="form-control" value="<?php echo $row['floor_area']; ?>" />
                        </td>
                        <td>EPC Rating: <br>
                            <input type="text" name="epc_rating" class="form-control"
                                value="<?php echo $row['epc_rating']; ?>" />
                        </td>
                    </tr>
                    <tr>
                        <td>
                            ...
                            <input type="text" name="property_condition" class="form-control"
                                value="<?php echo $row['property_condition']; ?>" />
                        </td>
                        <td>
                            Heating Type <br>
                            <input type="text" name="heating_type" class="form-control"
                                value="<?php echo $row['heating_type']; ?>" />
                        </td>
                        <td>
                            <a target="_blank" href="http://cti.voa.gov.uk/cti/inits.asp">Council Tax Band</a><br>
                            <input type="text" name="council_tax_band" class="form-control"
                                value="<?php echo $row['council_tax_band']; ?>" />
                        </td>
                        <td>
                            Council Tax Cost (Per Annum) </a><br>
                            <input type="text" name="council_tax_cost" placeholder="£" class="form-control"
                                value="<?php echo $row['council_tax_cost']; ?>" />
                        </td>
                    </tr>
                    <tr>
                        <td>Service Charge: <br>
                            <input type="text" name="service_charge" placeholder="£" class="form-control"
                                value="<?php echo $row['service_charge']; ?>" />
                        </td>
                        <td>Ground Rent: <br>
                            <input type="text" name="ground_rent" placeholder="£" class="form-control"
                                value="<?php echo $row['ground_rent']; ?>" />
                        </td>
                        <td>Remaining Leasehold: <br>
                            <input type="text" name="leasehold_remaining" class="form-control"
                                value="<?php echo $row['leasehold_remaining']; ?>" />
                        </td>
                        <td>Property Age: <br>
                            <input type="text" name="property_age" class="form-control"
                                value="<?php echo $row['property_age']; ?>">
                        </td>
                    </tr>
                    <tr>
                    <tr>
                        <td colspan="2">
                            Feature 1: <input style="width:100%; margin-top: 12px; margin-bottom: 6px" type="text"
                                name="feature_1" class="form-control" value="<?php echo $row['feature_1']; ?>" /><br>
                            Feature 2: <input style="width:100%; margin-top: 3px; margin-bottom: 6px" type="text"
                                name="feature_2" class="form-control" value="<?php echo $row['feature_2']; ?>" /> <br>
                            Feature 3: <input style="width:100%; margin-top: 3px; margin-bottom: 6px" type="text"
                                name="feature_3" class="form-control" value="<?php echo $row['feature_3']; ?>" /><br>
                            Feature 4: <input style="width:100%; margin-top: 3px; margin-bottom: 6px" type="text"
                                name="feature_4" class="form-control" value="<?php echo $row['feature_4']; ?>" /><br>
                            Feature 5: <input style="width:100%; margin-top: 3px; margin-bottom: 6px" type="text"
                                name="feature_5" class="form-control" value="<?php echo $row['feature_5']; ?>" /><br>
                        </td>
                        <td colspan="2">
                            Feature 6: <input style="width:100%; margin-top: 12px; margin-bottom: 6px" type="text"
                                name="feature_6" class="form-control" value="<?php echo $row['feature_6']; ?>" /><br>
                            Feature 7: <input style="width:100%; margin-top: 3px; margin-bottom: 6px" type="text"
                                name="feature_7" class="form-control" value="<?php echo $row['feature_7']; ?>" /> <br>
                            Feature 8: <input style="width:100%; margin-top: 3px; margin-bottom: 6px" type="text"
                                name="feature_8" class="form-control" value="<?php echo $row['feature_8']; ?>" /><br>
                            Feature 9: <input style="width:100%; margin-top: 3px; margin-bottom: 6px" type="text"
                                name="feature_9" class="form-control" value="<?php echo $row['feature_9']; ?>" /><br>
                            Feature 10: <input style="width:100%; margin-top: 3px; margin-bottom: 6px" type="text"
                                name="feature_10" class="form-control" value="<?php echo $row['feature_10']; ?>" /><br>
                        </td>
                    </tr>
                    <th colspan="4">
                        Landord Details:
                    ...
                    <tr>
                        <td>Access Through: <br>
                            <input type="text" name="access_through" class="form-control"
                                value="<?php echo $row['access_through']; ?>" />
                        </td>
                        <td>
                            Name:
                            <br>
                            <input name="viewing_arrangements_name" type="text" id="viewing_arrangements_name"
                                class="form-control" value="<?php echo $row['viewing_arrangements_name']; ?>" />
                        </td>
                        <td>
                            Contact Number:
                            <br>
                            <input name="viewing_arrangements_contact_number" type="text"
                                id="viewing_arrangements_contact_number" class="form-control"
                                value="<?php echo $row['viewing_arrangements_contact_number']; ?>">
                        </td>
                        <td>
                            Email:
                            <br>
                            <input name="viewing_arrangements_email" type="text" id="viewing_arrangements_email"
                                class="form-control" value="<?php echo $row['viewing_arrangements_email']; ?>">
                        </td>

                    </tr>
                    <tr>
                        <th 
                            class="labelCol3" colspan="4">Parking:<br>
                        </th>
                    </tr>
                    <td colspan="4" class="dataCol3">
                        <table width="100%" cellpadding="0" cellspacing="0">
                            <tbody>
                                <tr>
                                    <td>
                                        <input name="parking_type" class="form-control" type="text" id="parking"
                                            value="<?php echo $row['parking_type']; ?>">
                                    </td>
                                </tr>
                            </tbody>
                        </table>
                    ...
                    <td colspan="4" class="dataCol3">
                        <table width="100%" cellpadding="0" cellspacing="0">
                            <tbody>
                                <tr>
                                    <td>
                                        <input name="outside_space" class="form-control" type="text" id="outside_space"
                                            value="<?php echo $row['outside_space']; ?>">
                                    </td>
                                </tr>
                            </tbody>
                        </table>
