                ...
                <table class="table table-bordered">
                    ...
                    <tr>
                        ...
                        <td> <h4>Status: </h4><br>
                            ...
                            <label>
                                <input name="lettings_availability[]" type="radio" class = "jpoutsidespace" id="lettings_availability[]" value="Available"> Available
                            </label>
                            <br/>
                            <label>
                                <input name="lettings_availability[]" type="radio" class = "jpoutsidespace" id="lettings_availability[]" value="On Hold"> On Hold
                            </label>
                            <br/>
                            <label>
                                <input name="lettings_availability[]" type="radio" class = "jpoutsidespace" id="lettings_availability[]" value="Under Offer"> Under Offer
                            </label>
                            <br/>
                            <label>
                                <input name="lettings_availability[]" type="radio" class = "jpoutsidespace" id="lettings_availability[]" value="Let Agreed"> Let Agreed
                            </label>
                            <br/>
                    ...
                    <tr>
                        ...
                        <td>
                            <a target="_blank" href="https://www.epcregister.com/reportSearchAddressTerms.html?redirect=reportSearchAddressByPostcode"> Floor Area:</a><br>  <input type="text" name="floor_area" placeholder="sq.m." class="form-control"/>
                        </td>
                    </tr>
                    <tr>
                        <td >
                ...
                <table width="100%" cellpadding="0" cellspacing="0">
                    <tbody>
                        <tr>
                            <td width="33%">
                                <label>
                                    <input name="parking_details[]" class = "jpparking" type="checkbox" id="parking[]" value="Garage" class="form-control"> Garage
                                </label>
                            </td>
                            <td width="33%">
                                <label>
                                    <input name="parking_details[]" class = "jpparking" type="checkbox" id="parking[]" value="Double Garage" class="form-control"> Double Garage
                                </label>
                            </td>
                            <td width="33%">
                                <label>
                                    <input name="parking_details[]" class = "jpparking" type="checkbox" id="parking[]" value="Triple Garage" class="form-control"> Triple Garage
                                </label>
                            </td>
                        </tr>
                        <tr>
                            <td>
                                <label>
                                    <input name="parking_details[]" type="checkbox" class = "jpparking" id="parking[]" value="Carport" class="form-control"> Carport
                                </label>
                            </td>
                            <td>
                                <label>
                                    <input name="parking_details[]" type="checkbox" class = "jpparking" id="parking[]" value="Off Road Parking" class="form-control"> Off Road Parking
                                </label>
                            </td>
                            <td>
                                <label>
                                    <input name="parking_details[]" type="checkbox" class = "jpparking" id="parking[]" value="On Road Parking" class="form-control"> On Road Parking
                                </label>
                            </td>
                        </tr>
                        <tr>
                            <td>
                                <label>
                                    <input name="parking_details[]" type="checkbox" class = "jpparking" id="parking[]" value="Permit Parking" class="form-control"> Permit Parking
                                </label>
                            </td>
                            <td>
                                <label>
                                    <input name="parking_details[]" type="checkbox" class = "jpparking" id="parking[]" value="Secure Gated Parking" class="form-control"> Secure Gated Parking
                                </label>
                            </td>
                            <td>
                                <label>
                                    <input name="parking_details[]" type="checkbox" class = "jpparking" id="parking[]" value="Allocated Parking" class="form-control"> Allocated Parking
                                </label>
                            </td>
                        </tr>
                    </tbody>
