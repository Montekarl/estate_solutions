...
if(isset($_POST['btn-save']))
    {
        ...
        $lettings_availability = isset($_POST['lettings_availability']) ? mysqlescape($_POST['lettings_availability']):false;
        $ilettings_availability = is_array($lettings_availability) ? implode(", ",$lettings_availability): false;
        ...
        $parking_details = isset($_POST['parking_details']) ? mysqlescape($_POST['parking_details']) : false;
        $iparking_details = is_array($parking_details) ? implode(", ", $parking_details) : false;
        ...
        $propertyFeature = isset($_POST['propertyFeature']) ? mysqlescape($_POST['propertyFeature']): false;
        $ipropertyFeature = is_array($propertyFeature) ? implode(", ",$propertyFeature): false;
        ...
        $sql_query = "INSERT INTO lettings_properties(Address1,Address2,Address3,postcode,property_level,
        lettings_availability,dwelling_type,price,available_from,bedrooms,bathrooms,receptions,borough,garden,
        parking,access_through,floor_area,property_age,property_condition,heating_type,
        council_tax_band,council_tax_cost,key_tag,feature_1,feature_2,feature_3,feature_4,feature_5,feature_6,
        feature_7,feature_8,feature_9,feature_10,landlord_fn,landlord_ln,landlord_contact,landlord_email,
        landlord_address,parking_details,outside_space,viewing_arrangements_name,
        viewing_arrangements_contact_number,viewing_arrangements_email,viewing_arrangements_notes,
        pets_allowed,children_allowed,sharers_allowed,students_allowed) 
        VALUES('$Address1','$Address2','$Address3','$postcode','$property_level','$ilettings_availability',
        '$dwelling_type','$price','$available_from','$bedrooms','$bathrooms','$receptions','$borough','$garden',
        '$parking','$access_through','$floor_area','$property_age','$property_condition',
        '$heating_type','$council_tax_band','$council_tax_cost','$key_tag','$feature_1',
        '$feature_2','$feature_3','$feature_4','$feature_5','$feature_6','$feature_7',
        '$feature_8','$feature_9','$feature_10','$landlord_fn','$landlord_ln','$landlord_contact',
        '$landlord_email','$landlord_address','$iparking_details','$ioutside_space',
        '$viewing_arrangements_name','$viewing_arrangements_contact_number',
        '$viewing_arrangements_email','$viewing_arrangements_notes','$pets_allowed',
        '$children_allowed','$sharers_allowed','$students_allowed')";
                    ...
                    <table class="table table-bordered">
                        ...
                        <tr>
                            ...
                            <td> 
                                ...
                                <br/>
                                <label>
                                    <input name="lettings_availability[]" type="radio" class = "jpoutsidespace" id="lettings_availability[]" value="Available"> 
                                    Available
                                </label>

                                <br/>
                                <label>
                                    <input name="lettings_availability[]" type="radio" class = "jpoutsidespace" id="lettings_availability[]" value="On Hold"> 
                                    On Hold
                                </label>

                                <br/>
                                <label>
                                    <input name="lettings_availability[]" type="radio" class = "jpoutsidespace" id="lettings_availability[]" value="Under Offer"> 
                                    Under Offer
                                </label>

                                <br/>
                                <label>
                                    <input name="lettings_availability[]" type="radio" class = "jpoutsidespace" id="lettings_availability[]" value="Let Agreed"> 
                                    Let Agreed
                                </label>
                        ...
                        <tr>
                            ...
                            <td>
                                <a target="_blank" href="http://cti.voa.gov.uk/cti/inits.asp">
                                    Council Tax Band
                                </a>
                        ...
                        <tr>
                            <td>
                                Pets Allowed: <br>
                                <select id="pets_allowed" name="pets_allowed" class="form-control">
                                    <option></option>
                                    <option value="yes">Yes</option>
                                    <option value="no">No</option>
                                </select>
                            ...
                            <td>
                                Children Allowed: <br>
                                <select id="children_allowed" name="children_allowed" class="form-control">
                                    <option></option>
                                    <option value="yes">Yes</option>
                                    <option value="no">No</option>
                                </select>
                            ...
                            <td>
                                Sharers Allowed: <br>
                                <select id="sharers_allowed" name="sharers_allowed" class="form-control">
                                    <option></option>
                                    <option value="yes">Yes</option>
                                    <option value="no">No</option>
                                </select>
                        ...
                        <tr>
                            ...
                            <td>
                                Special Notes:
                                <br>
                                <input name="viewing_arrangements_notes" type="text" id="viewing_arrangements_notes" class="form-control">
                            </td>
                        </tr>
                                ...
                                <table width="100%" cellpadding="0" cellspacing="0">
                                    <tbody>
                                        <tr>
                                            <td width="33%">
                                                <label>
                                                    <input name="parking_details[]" class = "jpparking" type="checkbox" id="parking[]" value="Garage" class="form-control"> 
                                                    Garage
                                                </label>
                                            </td>
                                            ...
                                            <td width="33%">
                                                <label>
                                                    <input name="parking_details[]" class = "jpparking" type="checkbox" id="parking[]" value="Double Garage" class="form-control"> 
                                                    Double Garage
                                                </label>
                                            </td>
                                            ...
                                            <td width="33%">
                                                <label>
                                                    <input name="parking_details[]" class = "jpparking" type="checkbox" id="parking[]" value="Triple Garage" class="form-control"> 
                                                    Triple Garage
                                                </label>
                                            </td>
                                        </tr>
                                        ...
                                        <tr>
                                            <td>
                                                <label>
                                                    <input name="parking_details[]" type="checkbox" class = "jpparking" id="parking[]" value="Carport" class="form-control"> 
                                                    Carport
                                                </label>
                                            </td>
                                            <td>
                                                <label>
                                                    <input name="parking_details[]" type="checkbox" class = "jpparking" id="parking[]" value="Off Road Parking" class="form-control"> 
                                                    Off Road Parking
                                                </label>
                                            </td>
                                            <td>
                                                <label>
                                                    <input name="parking_details[]" type="checkbox" class = "jpparking" id="parking[]" value="On Road Parking" class="form-control"> 
                                                    On Road Parking
                                                </label>
                                            </td>
                                        </tr>
                                        ...
                                        <tr>
                                            <td>
                                                <label>
                                                    <input name="parking_details[]" type="checkbox" class = "jpparking" id="parking[]" value="Permit Parking" class="form-control"> 
                                                    Permit Parking
                                                </label>
                                            </td>
                                            <td>
                                                <label>
                                                    <input name="parking_details[]" type="checkbox" class = "jpparking" id="parking[]" value="Secure Gated Parking" class="form-control"> 
                                                    Secure Gated Parking
                                                </label>
                                            </td>
                                            <td>
                                                <label>
                                                    <input name="parking_details[]" type="checkbox" class = "jpparking" id="parking[]" value="Allocated Parking" class="form-control"> 
                                                    Allocated Parking
                                                </label>
                                            </td>
                                        </tr>
                            ...
                            <table width="100%" cellpadding="0" cellspacing="0">
                                <tbody>
                                    <tr>
                                        <td width="33%">
                                            <label>
                                                <input name="outside_space[]" type="checkbox" class = "jpoutsidespace" id="outside_space[]" value="Conservatory"> 
                                                Conservatory
                                            </label>
                                        </td>
                                        <td width="33%">
                                            <label>
                                                <input name="outside_space[]" type="checkbox" class = "jpoutsidespace" id="outside_space[]" value="Communal Garden"> 
                                                Communal Garden
                                            </label>
                                        </td>
                                        <td width="33%">
                                            <label>
                                                <input name="outside_space[]" type="checkbox" class = "jpoutsidespace" id="outside_space[]" value="Large Garden"> 
                                                Large Garden
                                            </label>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                            <label>
                                                <input name="outside_space[]" type="checkbox" class = "jpoutsidespace" id="outside_space[]" value="Balcony"> 
                                                Balcony
                                            </label>
                                        </td>
                                        <td>
                                            <label>
                                                <input name="outside_space[]" type="checkbox" class = "jpoutsidespace" id="outside_space[]" value="Patio" > 
                                                Patio
                                            </label>
                                        </td>
                                        <td>
                                            <label>
                                                <input name="outside_space[]" type="checkbox" class = "jpoutsidespace" id="outside_space[]" value="South Facing Garden"> 
                                                South Facing Garden
                                            </label>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                            <label>
                                                <input name="outside_space[]" type="checkbox" class = "jpoutsidespace" id="outside_space[]" value="Roof Terrace"> 
                                                Roof Terrace
                                            </label>
                                        </td>
                                        <td>
                                            <label>
                                                <input name="outside_space[]" type="checkbox" class = "jpoutsidespace" id="outside_space[]" value="Garden"> 
                                                Garden
                                            </label>
                                        </td>
                                        <td>
                                            <label>
                                                <input name="outside_space[]" type="checkbox" class = "jpoutsidespace" id="outside_space[]" value="Off-Street Parking"> 
                                                Off-Street Parking
                                            </label>
                                        </td>
                                    </tr>
                        ...
                        <script type = "text/javascript">
                            ...
                            {
                                isChecked = !isChecked;
                                $('input:checkbox.jppropertyFeature').attr('checked',isChecked);
                            }
                        </script>
                </div>
            </div>
