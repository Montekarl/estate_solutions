...
<td colspan="3" >
Address Line 1: <br>
<input style="margin-top: 12px; margin-bottom: 6px" type="text" name="Address1" class="form-control"><br>
Address Line 2: <br>
<input style="margin-top: 3px; margin-bottom: 6px" type="text" name="Address2" class="form-control"><br>
Address Line 3: <br>
<input style="margin-top: 3px; margin-bottom: 6px" type="text" name="Address3" class="form-control"><br>
Postcode: <br>
...
<label>
<input name="sales_availability[]" type="radio" value="Available"> Available
</label>
<br/>
<label>
<input name="sales_availability[]" type="radio" value="On Hold"> On Hold
</label>
<br/>
<label>
<input name="sales_availability[]" type="radio" value="Under Offer"> Under Offer
</label>
<br/>
<label>
<input name="sales_availability[]" type="radio" value="Sold"> Sold
</label>
<br/>
...
Floor Area:</a><input type="text" name="floor_area" placeholder="sq.m." class="form-control" ></td>
<td>EPC Rating: <select name="epc_rating" class="form-control" >
<option></option>
