...
<div id="body">
    <div id="content">
        <table style ="width:100%">
            <tr>
                <th colspan="3" class="menutable"><a href="index.php">Lettings Applicants</a></th>
                <th colspan="3" class="menutable"><a href="property_lettings_data.php">Lettings Property</a></th>
                <th colspan="3" class="menutable"><a href="new_viewing.php">New Viewing</a></th>
                <th colspan="3" class="menutable"><a href="#">Property Match</a></th>
                <th colspan="3" class="menutable"><a href="#">Lettings Offer</a></th>

            </tr>
            <tr>
                <th colspan="3" class="menutable"><a href="sales_data.php">Sales Applicants</a></th>
                <th colspan="3" class="menutable"><a href="property_sales_data.php">Sales Property</a></th>
                <th colspan="3" class="menutable"><a href="viewings_database.php">Viewing Database</a></th>
                <th colspan="3" class="menutable"><a href="#">Applicant Match</a></th>
                <th colspan="3" class="menutable"><a href="#">Sales Offer</a></th>
            </tr>
                ...
                <tr>
                    <td colspan="4">
                        ...
                        function filterTable($query){
                            global $conn;
                            //$connect = mysqli_connect("localhost:3306","montechr_user","sK[kH?3XF?t;XxhoKF","montechr_dbtuts
");
